  ...
  <KakaoMap :center="{ lat: 37.5013, lng: 127.0395 }" :level="8" style="width: 100%; height: 95vh;"
    ...
    <Marker :position="pos" @mouseover="open = true" @mouseout="open = false">
      <InfoWindow :open="open">
        <div style="width: 100px; padding: 5px 5px;">
          <div style="display: flex; gap: 4px"><span>Lat:</span><span>{{ pos.lat.toFixed(6) }}</span></div>
          <div style="display: flex; gap: 4px"><span>Lng:</span><span>{{ pos.lng.toFixed(6) }}</span></div>
        </div>
      </InfoWindow>
    </Marker>
    ...
    <CustomOverlay :position="{ lat: 37.5, lng: 127.1 }" :visible="showCustomOverlay">
      <div class="overlaybox">
        ...
        <ul>
          <li class="up"> <span class="number">2</span> <span class="title">명량</span> <span class="arrow up"></span> <span
              class="count">2</span> </li>
          <li> <span class="number">3</span> <span class="title">해적(바다로 간 산적)</span> <span class="arrow up"></span> <span
              class="count">6</span> </li>
          <li> <span class="number">4</span> <span class="title">해무</span> <span class="arrow up"></span> <span
              class="count">3</span> </li>
          <li> <span class="number">5</span> <span class="title">안녕, 헤이즐</span> <span class="arrow down"></span> <span
